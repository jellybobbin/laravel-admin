...
[![Packagist](https://img.shields.io/packagist/l/jellybobbin/laravel-admin.svg?maxAge=2592000)](https://packagist.org/packages/jellybobbin/laravel-admin)
[![Total Downloads](https://img.shields.io/packagist/dt/jellybobbin/laravel-admin.svg?style=flat-square)](https://packagist.org/packages/jellybobbin/laravel-admin)
...
```
composer require jellybobbin/laravel-admin 1.5.*
```

Then run these commands to publish assets and config：

```
php artisan vendor:publish --provider="JellyBobbin\Admin\AdminServiceProvider"
```

...
`JellyBobbin\Admin\Widgets\Box` used to generate box components:

```php
use JellyBobbin\Admin\Widgets\Box;
...
`JellyBobbin\Admin\Widgets\Collapse` class used to generate folding components:
```php
use JellyBobbin\Admin\Widgets\Collapse;
...
`JellyBobbin\Admin\Widgets\Form` class is used to quickly build a form：
...
The `JellyBobbin\Admin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use JellyBobbin\Admin\Widgets\InfoBox;
...
The `JellyBobbin\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use JellyBobbin\Admin\Widgets\Tab;
...
`JellyBobbin\Admin\Widgets\Table` class is used to generate forms：

```php
use JellyBobbin\Admin\Widgets\Table;

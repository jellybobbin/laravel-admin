...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \JellyBobbin\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('JellyBobbin\Admin\AdminServiceProvider');
    ...
    public function setUp()
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'JellyBobbin\Admin\AdminServiceProvider']);

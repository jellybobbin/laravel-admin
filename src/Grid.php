...
use JellyBobbin\Admin\Grid\Displayers\Actions;
use JellyBobbin\Admin\Grid\Displayers\RowSelector;
use JellyBobbin\Admin\Grid\Exporter;
use JellyBobbin\Admin\Grid\Filter;
use JellyBobbin\Admin\Grid\Model;
use JellyBobbin\Admin\Grid\Row;
use JellyBobbin\Admin\Grid\Tools;
...
class Grid
{
     ...
     *
     * @var \JellyBobbin\Admin\Grid\Model
     */
    protected $model;
     ...
     * The grid Filter.
     *
     * @var \JellyBobbin\Admin\Grid\Filter
     */
    protected $filter;
    ...
    {
        $map = [
            'editable'    => \JellyBobbin\Admin\Grid\Displayers\Editable::class,
            'switch'      => \JellyBobbin\Admin\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \JellyBobbin\Admin\Grid\Displayers\SwitchGroup::class,
            'select'      => \JellyBobbin\Admin\Grid\Displayers\Select::class,
            'image'       => \JellyBobbin\Admin\Grid\Displayers\Image::class,
            'label'       => \JellyBobbin\Admin\Grid\Displayers\Label::class,
            'button'      => \JellyBobbin\Admin\Grid\Displayers\Button::class,
            'link'        => \JellyBobbin\Admin\Grid\Displayers\Link::class,
            'badge'       => \JellyBobbin\Admin\Grid\Displayers\Badge::class,
            'progressBar' => \JellyBobbin\Admin\Grid\Displayers\ProgressBar::class,
            'radio'       => \JellyBobbin\Admin\Grid\Displayers\Radio::class,
            'checkbox'    => \JellyBobbin\Admin\Grid\Displayers\Checkbox::class,
            'orderable'   => \JellyBobbin\Admin\Grid\Displayers\Orderable::class,
        ];
